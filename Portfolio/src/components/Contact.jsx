...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Create FormData object for Google Sheets
                      ...
                      {contactInfo.map((info, index) => (
                        ...
                        >
                          <div className="flex items-center space-x-4">
                            <div className={`w-12 h-12 flex items-center justify-center rounded-full ${info.color} group-hover:scale-110 transition-transform duration-200`}>
                ...
                <div className="text-center mt-16">
                  ...
                  <div className="flex items-center justify-center space-x-6">
                    {[
                      ...
                      { icon: 'github', href: '#', color: 'hover:text-gray-800 dark:hover:text-gray-300' },
